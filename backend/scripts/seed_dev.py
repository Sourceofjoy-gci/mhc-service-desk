...
from apps.catalogue.models import Service  # noqa: E402
...
def main():
    ...
    ensure_service("GEN-INFO", "General information and office contact", "operational")
    ensure_service("EST-REG", "Estate registration or reference enquiry", "operational")
    ensure_service("WIL-REG", "Will registration or safekeeping enquiry", "operational")
    ensure_service("IT-ACCESS", "Identity and access request", "it")
    ensure_service("IT-INC", "IT incident report", "it")
